    ...
    module GeneralTreeToPostScript
        ...
        let rec makeTreePS h level shift =
                function Node ((label,f),st) ->
                           ...
                           let labelPS =  [shiftfstring;psSPACE;I (-quarterh-levelh) ;psMOVETO;//move to absolute position
                           ...
                           let lineInPS = if level < 1 then [] else
                                            [shiftfstring;psSPACE;I (-levelh) ;psMOVETO;
                           ...
                           let lineOutPS = if List.isEmpty st then 
                                               ...
                                               [shiftfstring;psSPACE; I(eighth+levelandhalfh) ;psMOVETO;//move below label of node
